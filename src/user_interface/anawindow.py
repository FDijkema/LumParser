...
class AnaFrame(tk.Frame):
    ...
    def __init__(self, parent, controller, signalgroup=None):
        ...
        #self.extra_options = tk.Frame(self.main_window)
    ...
    def fit(self):
        ...
        :return:
        """
        s_name = self.tools.browser_box.get("active")
        ...
        if "fit" not in self.tools.optionslist:
            self.tools.optionslist.append("fit")
